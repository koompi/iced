...
use iced_native::table::{self, TableColumn, TableData};
use iced_native::{
    Background, Color, HorizontalAlignment, Layout, Point, Rectangle, Vector,
    VerticalAlignment,
};
        ...
        for (record, record_layout) in data.iter().zip(body_layout.children()) {
            ...
            let record_cells = columns
                ...
                .fold(
                    ...
                    |mut record_cells, (value, cell_layout)| {
                        ...
                        record_cells.push(Primitive::Clip {
                            bounds,
